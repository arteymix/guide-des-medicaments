 ...
 * @author Aldo Lamarre
 */
public class DrugsActivity extends ActionBarActivity implements LoaderManager.LoaderCallbacks<List<RxNorm.Rxcui>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportLoaderManager()
                .initLoader(DRUGS_LOADER, getIntent().getExtras(), this)
                .forceLoad();
    }
    ...
    public void onNewIntent(final Intent intent) {
        getSupportLoaderManager()
                .restartLoader(DRUGS_LOADER, intent.getExtras(), this)
                .forceLoad();
    }
